...
class PyTorchWorker(Worker):
	def __init__(self, N_train = 32768, N_valid = 8192, **kwargs):
	...
	def compute(self, config, budget, working_directory, *args, **kwargs):
		...
		for epoch in range(int(budget)):
			...
			print("BUDGET TYPE IS ", type(budget))
			if epoch % int(0.1*budget) == 0:
				dataloader = GLISTERDataLoader(self.train_loader, 
