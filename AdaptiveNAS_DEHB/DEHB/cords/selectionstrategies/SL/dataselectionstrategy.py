...
class DataSelectionStrategy(object):
    ...
    def update_model(self, model_params):
        ...
        """
        #model_state_dict = model_params['state_dict']
        #arch_parameters = model_params['alpha']
        #if '_arch_parameters' in model_state_dict: del model_state_dict['_arch_parameters']

        self.model.load_state_dict(model_params)
        #self.model.set_arch_parameters(arch_parameters)
        #self.model.optimizer.load_state_dict(model_params['optimizer'])
