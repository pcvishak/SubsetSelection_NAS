...
parser.add_argument('--entropy_file', type=str, 
                    default='./entropy_list/cifar10_resnet20_index_entropy_class.txt', 
...
parser.add_argument('--histogram', action='store_true', default=True, help='use histogram-based sampling')
